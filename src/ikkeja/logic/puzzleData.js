/**
 * Static puzzle content for all four IKKE-JA escape room levels.
 */

/** Showroom maze room graph — IKKE-JA afdelingen with optional korte routes. */
export const MAZE_ROOMS = {
  ...
  kantoor: {
    ...
    traps: {
      ...
      east: 'IKKE-JA Family balie — wachtrij val.',
    },
    blueprint: { x: 4, y: 0 },
  },
  badkamers: {
...
export const PLAYER_ROSTER = [
  {
    ...
    name: 'Player 1',
    title: 'Navigator',
    description: 'Map reader — guides the team through the store.',
  },
  {
    role: 'p2',
    name: 'Player 2',
    title: 'Explorer',
    description: 'Moves through rooms and reads the 4CODE on completion.',
  },
  {
    role: 'daughter',
    name: 'Player 3',
    title: 'Hints',
    description: 'Scene hints and trap warnings for the team.',
  },
];
